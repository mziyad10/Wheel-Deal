...
import {dummyMyBookingsData} from '../../src/assets/assets'
...
const ManageBookings = () => {
  ...
  return (
    <div className='px-4 pt-10 md:px-10 w-full'>
      ...
      <div className="max-w-3xl w-full rounded-md overflow-hidden mt-6 border border-borderColor">
            ...
            {bookings.map((booking, index)=>(
              <tr key={index} className='border-t border-borderColor text-gray-500'>
                ...
                <td className="p-3 flex items-center gap-2">
                  <img src={booking.car.image} alt="" className='h-14 w-14 aspect-square rounded-md object-cover'/>
