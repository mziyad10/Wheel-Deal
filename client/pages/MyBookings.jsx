...
import {assets, dummyMyBookingsData} from '../src/assets/assets'
          ...
          <div key={booking._id} className='grid grid-cols-1 md:grid-cols-4 gap-6 p-6 border border-borderColor rounded-lg mt-5 first:mt-12'>
            ...
            <div className="md:col-span-2">
              ...
              <div className="flex items-start gap-2 mt-3">
                <img src={assets.calendar_icon_colored} alt="" className='mt-1 w-4 h-4'/>
                <div className="">
              ...
              <div className="flex items-start gap-2 mt-3">
                <img src={assets.location_icon_colored} alt="" className='mt-1 w-4 h-4'/>
                <div className="">
